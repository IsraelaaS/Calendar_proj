...
def main():
    ...
    event_text_frame = tk.LabelFrame(
        main_frame, bg='black', fg='white', highlightthickness=0, font=("Arial", 12))
    ...
    def add_event_and_enable_button():
        main_menu.gui_add_events(
            buttons_frame, calendar_visual, add_event_button)

    add_event_button = tk.Button(buttons_frame, text='Add Event', command=lambda: [
                                 add_event_button.config(state='disabled'), add_event_and_enable_button()])
